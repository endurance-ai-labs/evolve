/* =========================================================
   ...
   Evolve Private Wealth, LLC is a fictional firm. Every
...
const RP = {
  ...
  offices: [
    { city: "Los Angeles, CA", role: "Headquarters", staff: 18, aum: 1880000000 },
    { city: "New York, NY",    role: "East Coast",   staff: 6,  aum: 620000000 },
  ],
  ...
  feeSchedule: [
    ...
    { from: 5000000,  upTo: 10000000, rate: 0.0065, label: "Next $5M" },
    { from: 10000000, upTo: 25000000, rate: 0.0050, label: "Next $15M" },
...
const TARGET_AUM = 2500000000;
const TOTAL_HOUSEHOLDS = 312;
const ADVISORY_ONLY_AUA = 410000000;
...
/* =========================================================
   ...
   ========================================================= */
const HH_ROWS = [
  ["HH-0001","Whitmore Family","UHNW","EJ Kahn","TAX",41.2,"2022-11-04","CA","Founders","2026-03-12","Schwab","Robert & Diane Whitmore","Founder liquidity event 2019. Concentrated legacy position in the joint account is the central planning problem."],
  ["HH-0002","Ashcombe Family Trust","UHNW","Glen Strauss","END",96.2,"2022-02-19","CA","Founders","2026-01-22","Schwab","Katherine Ashcombe, Trustee","Third-generation family capital. Perpetual horizon, alternatives-heavy allocation, four grantor trusts."],
  ["HH-0003","Delacroix Household","UHNW","Jonathan Lewis","GRO",68.4,"2022-06-30","NY","Founders","2025-11-08","Pershing","Julien & Marta Delacroix","Two operating businesses still held outside the portfolio. Liquidity planning under way for 2027."],
  ["HH-0004","Sandoval Family Office","UHNW","EJ Kahn","END",52.6,"2023-09-14","CA","Founders","2026-05-30","Schwab","Elena Sandoval","Family office relationship. Evolve runs the marketable and alternatives book."],
  ["HH-0005","Brennan-Locke Trust","UHNW","Glen Strauss","TAX",34.8,"2022-04-02","CA","Founders","2026-02-18","Fidelity","Thomas Brennan-Locke","Irrevocable trust with two beneficiary lines. Distribution standard is HEMS."],
  ["HH-0006","Kettering Household","UHNW","Jonathan Lewis","BAL",29.4,"2023-01-25","NY","Founders","2026-04-09","Schwab","Alan & Rosalind Kettering","Retired 2024. The portfolio now funds the entire spending need."],
  ["HH-0007","Nakashima Family","UHNW","EJ Kahn","GRO",27.1,"2023-08-11","CA","Founders","2026-06-24","Fidelity","Kenji & Amy Nakashima","Still accumulating. Two children, both education trusts funded to the exclusion limit."],
  ["HH-0008","Ferraro Household","UHNW","Glen Strauss","TAX",31.5,"2022-10-07","CA","Founders","2025-07-14","Schwab","Vincent Ferraro","Real estate operator. The portfolio is the diversifying asset against the property book."],
  ["HH-0009","Okonkwo Family","HNW","Jonathan Lewis","GRO",24.1,"2023-03-19","CA","Private","2026-07-14","Schwab","Chidi & Ngozi Okonkwo","Two physicians. Peak earning years, aggressive savings rate."],
  ["HH-0010","Sterling Household","HNW","Hank Krakover","BAL",22.4,"2022-05-06","NY","Private","2026-01-15","Fidelity","Marjorie Sterling","Widowed 2023. Estate plan restructured; beneficiary review completed in March."],
  ["HH-0011","Vandermeer Trust","HNW","EJ Kahn","TAX",19.6,"2023-11-22","CA","Private","2026-03-27","Schwab","Hendrik Vandermeer","Grantor trust. Annual exclusion gifting programme running since inception."],
  ["HH-0012","Callahan Household","HNW","Hank Krakover","BAL",18.9,"2022-07-13","CA","Private","2025-12-04","Pershing","Sean & Bridget Callahan","Entertainment industry. Income is lumpy, so the reserve policy carries two years."],
  ["HH-0013","Ibarra Family","HNW","Glen Strauss","MOD",16.2,"2023-02-28","CA","Private","2026-05-19","Schwab","Rafael & Luz Ibarra","Business sale closed 2022. Conservative by preference, not by capacity."],
  ["HH-0014","Pemberton Household","HNW","Jonathan Lewis","GRO",14.8,"2024-06-08","NY","Private","2026-04-30","Fidelity","James Pemberton","Technology executive. Significant unvested equity outside the portfolio."],
  ["HH-0015","Roswell Family Trust","HNW","Hank Krakover","CON",12.6,"2022-09-01","CA","Private","2026-02-06","Schwab","Patricia Roswell, Trustee","Income-first mandate. Trust distributes quarterly to three beneficiaries."],
  ["HH-0016","Haddad Household","HNW","EJ Kahn","BAL",11.4,"2023-10-17","CA","Private","2026-06-11","Schwab","Nadim & Layla Haddad","Both approaching retirement in 2028. Glide path begins next year."],
  ["HH-0017","Lindqvist Household","HNW","Carly Whitmore","MOD",9.8,"2024-01-14","CA","Private","2025-06-23","Fidelity","Erik & Sofia Lindqvist","Dual citizens. Reporting requirements reviewed annually with counsel."],
  ["HH-0018","Ashworth Household","HNW","Carly Whitmore","BAL",8.6,"2023-08-30","NY","Private","2026-07-02","Pershing","Charles Ashworth","Sold a professional practice in 2021. Deferred compensation runs through 2029."],
  ["HH-0019","Marchetti Family","HNW","Hank Krakover","GRO",7.9,"2024-03-11","CA","Private","2026-05-08","Schwab","Gianni & Rosa Marchetti","Newer relationship. Consolidating from three prior advisers."],
  ["HH-0020","Thibodeaux Household","HNW","Carly Whitmore","CON",7.2,"2022-04-21","CA","Private","2026-01-29","Schwab","Marie Thibodeaux","Retired producer. Spending policy is 3.4% of a three-year average."],
  ["HH-0021","Osei-Bonsu Household","HNW","Jonathan Lewis","BAL",6.4,"2024-11-30","NY","Private","2026-06-27","Fidelity","Kwame & Adjoa Osei-Bonsu","Both in their forties. Education funding is the primary near-term goal."],
  ["HH-0022","Renner Household","HNW","Carly Whitmore","MOD",5.8,"2023-05-16","CA","Private","2025-08-05","Schwab","David & Kate Renner","Second-home purchase planned for 2027; liquidity reserved."],
  ["HH-0023","Aldridge Household","Emerging","Carly Whitmore","BAL",4.6,"2024-09-08","CA","Core","2026-04-15","Schwab","Simon Aldridge","Referred by the Kettering household."],
  ["HH-0024","Barros Household","Emerging","Priya Raghavan","GRO",4.2,"2025-01-19","CA","Core","2026-07-21","Schwab","Ana Barros","Early career, high savings rate, long horizon."],
  ["HH-0025","Chen Household","Emerging","Carly Whitmore","GRO",3.8,"2023-07-27","CA","Core","2026-03-05","Fidelity","Wei & Lin Chen","Two engineers. Concentrated employer stock managed down over three years."],
  ["HH-0026","Duarte Household","Emerging","Priya Raghavan","BAL",3.4,"2024-11-14","NY","Core","2026-05-27","Schwab","Isabel Duarte","Inherited portfolio, repositioned over four quarters to manage gains."],
  ["HH-0027","Eriksson Household","Emerging","Carly Whitmore","MOD",3.1,"2023-10-05","CA","Core","2026-02-13","Schwab","Anders Eriksson","Approaching retirement. Social Security claiming analysis completed."],
  ["HH-0028","Fontaine Household","Emerging","Priya Raghavan","BAL",2.8,"2025-06-02","CA","Core","2026-06-18","Fidelity","Claire Fontaine","Divorce settlement in 2023. Rebuilding the plan from a new baseline."],
  ["HH-0029","Girard Household","Emerging","Carly Whitmore","GRO",2.4,"2025-02-26","NY","Core","2026-07-09","Schwab","Luc Girard","Referred by a centre of influence at a New York law firm."],
  ["HH-0030","Hollis Household","Emerging","Priya Raghavan","CON",2.1,"2023-12-11","CA","Core","2026-01-08","Schwab","Margaret Hollis","Retired. Portfolio supplements a defined benefit pension."],
  ["HH-0031","Imada Household","Emerging","Carly Whitmore","BAL",1.9,"2024-09-21","CA","Core","2026-05-14","Pershing","Sara Imada","Business owner. Solo 401(k) established at onboarding."],
  ["HH-0032","Jelani Household","Emerging","Priya Raghavan","GRO",1.6,"2025-05-13","CA","Core","2026-06-30","Schwab","Amara Jelani","Physician in fellowship. Student loan strategy is part of the plan."],
  ["HH-0033","Kowalski Household","Emerging","Carly Whitmore","MOD",1.4,"2024-04-07","NY","Core","2026-03-19","Fidelity","Piotr Kowalski","Consolidated four legacy retirement accounts at onboarding."],
  ["HH-0034","Lemaire Household","Emerging","Priya Raghavan","CP",1.2,"2025-01-27","CA","Core","2026-07-28","Schwab","Yvette Lemaire","Newest relationship in the detailed book. Capital earmarked for a 2027 purchase."],
  ["HH-0035","Harrowfield Foundation","Institutional","Razmig Der-Tavitian","END",48.6,"2022-05-01","CA","Institutional","2026-02-25","Schwab","Board Investment Committee","Private foundation. 5% distribution requirement drives the spending policy."],
  ["HH-0036","Calloway Family Foundation","Institutional","Razmig Der-Tavitian","BAL",31.2,"2023-03-14","CA","Institutional","2026-04-16","Schwab","Grants Committee","Grant-making foundation, three-year average spending rule."],
  ["HH-0037","St. Aldate's School Endowment","Institutional","Razmig Der-Tavitian","END",22.4,"2023-08-22","NY","Institutional","2026-06-05","Fidelity","Finance Committee","School endowment. Spending policy 4.5% of a twelve-quarter average."],
  ["HH-0038","Meridian Health Retirement Plan","Institutional","Razmig Der-Tavitian","MOD",18.6,"2024-01-11","CA","Institutional","2026-05-21","Fidelity","Plan Committee","Defined contribution plan. Collective trusts only, no retail share classes."],
  ["HH-0039","Kettering Charitable Trust","Institutional","Jonathan Lewis","CON",12.4,"2023-07-19","NY","Institutional","2026-03-31","Schwab","Trustees","Charitable remainder trust connected to the Kettering household."],
  ["HH-0040","Ashcombe Donor-Advised Fund","Institutional","Glen Strauss","BAL",8.9,"2022-10-30","CA","Institutional","2026-01-17","Schwab","Katherine Ashcombe, Advisor","Granting vehicle for the Ashcombe family. Invested in the household model."],
];
...
const FIRM = (function () {
  ...
  firmSegments.forEach((seg) => {
    ...
    const rnd = _rand("ev-tail-" + seg.id);
...
const ADVISORS = [
  { name: "EJ Kahn",             title: "Founder & Managing Partner",       office: "Los Angeles", households: 46, tenure: 2022, capacity: 48 },
  { name: "Glen Strauss",        title: "Managing Partner",                 office: "Los Angeles", households: 44, tenure: 2022, capacity: 48 },
  { name: "Jonathan Lewis",      title: "Managing Partner",                 office: "New York",    households: 41, tenure: 2022, capacity: 48 },
  { name: "Razmig Der-Tavitian", title: "Chief Investment Officer & Managing Partner", office: "Los Angeles", households: 18, tenure: 2022, capacity: 24 },
  { name: "Hank Krakover",       title: "Portfolio Manager",                office: "Los Angeles", households: 38, tenure: 2022, capacity: 48 },
  { name: "Carly Whitmore",      title: "Wealth Adviser",                   office: "Los Angeles", households: 52, tenure: 2024, capacity: 48 },
  { name: "Priya Raghavan",      title: "Wealth Adviser",                   office: "New York",    households: 47, tenure: 2025, capacity: 48 },
];
...
const COMMITMENTS = (function () {
  ...
  eligible.forEach((h, hi) => {
    const rnd = _rand("ev-commit-" + h.id);
...
const TIEOUTS = (function () {
  ...
  if (failures.length && typeof console !== "undefined") {
    console.error("Evolve tie-out failures:", failures.map((f) => f[0]));
  }
  return results;
})();
