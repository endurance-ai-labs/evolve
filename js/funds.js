...
const FUND_ROWS = [
  ...
  ["F-005","Evolve Direct Index — US Large Cap","Kestrel Asset Management","USLC","DIRIDX","Index replication in individual securities with continuous loss harvesting","EVDI","2019-04-01",1840,1000,0.20,0,"Approved",[4,5,4,5,5,4],[13.8,12.1,13.4,null,12.9],null],
  ...
  /* --- Municipals --- */
  ["F-026","Evolve Municipal Ladder 1–15 Year","Halloway & Finch","MUNI","MSMA","Laddered high-grade municipals, customised to state of residence","EVML","2008-01-02",2840,500,0.25,0,"Approved",[5,5,4,5,5,5],[5.6,2.8,1.0,2.3,3.1],null],
  ...
  ["F-030","Evolve California Municipal SMA","Halloway & Finch","MUNI","MSMA","California state-specific ladder for high-bracket residents","EVCM","2011-06-01",1180,500,0.25,0,"Approved",[5,5,4,5,5,5],[5.5,2.7,0.9,2.2,2.8],null],
  ...
  ["F-037","Evolve Treasury Bill Ladder","Halloway & Finch","CASH","FSMA","Direct Treasury bill ladder for balances above $2M","EVTB","2022-01-04",940,2000,0.08,0,"Approved",[5,5,4,5,5,5],[4.8,4.6,null,null,4.4],null],
  ...
  ["F-069","Evolve Charitable Donor-Advised Fund","Ashford Capital Management","USLC","DAF","Granting vehicle invested in the household's own model","EVDAF","2009-01-01",412,5,0.25,0,"Approved",[5,5,4,5,5,5],[11.6,9.8,11.2,10.1,9.4],null],
