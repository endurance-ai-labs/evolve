...
(function () {
  ...
  fab.setAttribute("aria-label", "Open the Evolve Brain");
  fab.innerHTML = MARK;

  var panel = document.createElement("div");
  panel.className = "rb-panel";
  panel.innerHTML =
    '<div class="rb-head"><div class="t"><span class="dot"></span>Evolve Brain</div>'
    + '<div class="s">Reads the live portfolio data &middot; '
    + '<a href="/evolve/brain/">Open the full page</a></div></div>'
