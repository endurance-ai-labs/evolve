...
function researchIndex() {
  ...
  if (typeof ASSET_CLASSES !== "undefined") {
    ASSET_CLASSES.forEach((a) => ix.push({
      ...
      group: a.group, ref: a, href: "/evolve/committee/",
    }));
  }
  if (typeof HOUSE_VIEWS !== "undefined") {
    HOUSE_VIEWS.forEach((v) => ix.push({
      ...
      sub: v[2] + " horizon", group: "Committee", ref: v, href: "/evolve/committee/",
    }));
  }
...
const RS_LEARN_KEY = "ev-learn";
const RS_ADD_KEY = "ev-coverage";
