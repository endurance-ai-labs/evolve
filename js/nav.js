...
(function () {
  ...
  try { localStorage.setItem("ev-theme", "light"); } catch (e) {}
})();
...
const NAV_GROUPS = [
  ...
  },
  {
    id: "research", label: "Research", items: [
      ...
      { href: BASE + "/alternatives/", label: "Alternatives Platform" },
    ],
  },
  {
...
const _GROUP_OF = {
  ...
  "/committee/": "research", "/private/": "research", "/alternatives/": "research",
    ...
    <div class="portal-topbar">
      <a class="brand" href="${BASE}/" style="cursor:pointer;text-decoration:none">
        ...
        <div class="rp-brand-text">
          <div class="rp-word">Evolve <span>Partners</span></div>
...
function _wireThemeToggle() {
  ...
  function apply(theme) {
    ...
    try { localStorage.setItem("ev-theme", theme); } catch (e) {}
