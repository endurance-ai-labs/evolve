      ...
      <div class="rp-scroll" style="max-height:400px">
        <table class="demo-tbl">
          ...
          <tbody>${calls.map((c) => {
            ...
            return `<tr class="rp-click" onclick="location.href='/evolve/households/household/?id=${c.hhId}&tab=private'">
    ...
    ${panel("Fund positions", `
      <div class="rp-scroll">
        <table class="demo-tbl">
          ...
          <tbody>${funds.map((f) => `<tr class="rp-click" onclick="location.href='/evolve/funds/fund/?id=${f.id}'">
