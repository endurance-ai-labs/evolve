/* =========================================================
   ...
   metrics, operational due diligence and the Evolve
...
function renderFund() {
  ...
  <div class="demo-kpis">
    ...
    <div class="demo-kpi"><div class="v">${f.scoreAvg == null ? "—" : f.scoreAvg.toFixed(1)}</div>
      <div class="l">Evolve score</div><div class="s">Average of six dimensions</div></div>
  ...
  <div class="demo-grid demo-two">
    ${panel("Terms", `
      <dl class="rp-dl">
        <dt>Manager</dt><dd><a href="/evolve/managers/?id=${mgr ? mgr.id : ""}" style="color:var(--color-blue)">${esc(f.manager)}</a></dd>
      ...
      ${households.length ? `<div class="rp-scroll" style="max-height:220px;margin-top:14px">
        <table class="demo-tbl">
          ...
          <tbody>${households.map((id) => {
            ...
            return `<tr class="rp-click" onclick="location.href='/evolve/households/household/?id=${id}&tab=holdings'">
