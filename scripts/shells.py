...
PAGES = [
    ...
    ("",             "home",        "Evolve Private Wealth — Private Wealth Portal", "Private Wealth Portal",
    ...
    ("alternatives", "alternatives", "Alternatives Platform", "Portal", "Manager access, capacity, co-investment and the pacing behind twenty years of alternatives work."),
    ("brain",        "brain",       "Evolve Brain",              "Private Wealth Portal", "Ask questions of the live portfolio, household and fund data."),
]
...
<title>{title} &middot; Evolve Private Wealth</title>
<meta name="description" content="{desc}">
<meta property="og:site_name" content="Evolve Private Wealth">
<meta property="og:title" content="{title} &middot; Evolve Private Wealth">
<meta property="og:description" content="{desc}">
<meta property="og:type" content="website">
<link rel="icon" type="image/svg+xml" href="{base}/assets/brand/evolve-mark.svg">
<link rel="stylesheet" href="{base}/css/theme.css">
<link rel="stylesheet" href="{base}/css/demo.css">
<link rel="stylesheet" href="{base}/css/evolve.css">
</head>
<body>
<div id="topbar"></div>
<main class="page">
